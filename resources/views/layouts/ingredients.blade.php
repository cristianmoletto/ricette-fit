    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-success shadow-sm">
        <div class="container">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                data-bs-target="#navbarIngredients" aria-controls="navbarIngredients"
                aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarIngredients">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                            ...
                            <li>
                                <a class="dropdown-item text-danger" href="{{ route('logout') }}"
                                    onclick="event.preventDefault(); document.getElementById('logout-form-ingredients').submit();">
                                    <i class="bi bi-box-arrow-right me-2"></i>Logout
                                </a>
                                <form id="logout-form-ingredients" action="{{ route('logout') }}" method="POST" class="d-none">
                                    @csrf
                                </form>
                            </li>
                        </ul>
